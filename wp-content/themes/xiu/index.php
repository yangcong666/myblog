...
<div class="content-wrap">
	<div class="content">
		<?php 
			if( _hui('ads_index_01_s') ) echo '<div class="ssr ssr-content">'.hui_get_adcode('ads_index_01').'</div>'; 
		...
		<?php echo _hui('ads_index_02_s') ? '<div class="ssr ssr-content">'.hui_get_adcode('ads_index_02').'</div>' : '' ?>
		<?php 
			if( $paged && $paged > 1 ){
		...
		?>
		<?php echo _hui('ads_index_03_s') ? '<div class="ssr ssr-content">'.hui_get_adcode('ads_index_03').'</div>' : '' ?>
	</div>
</div>
