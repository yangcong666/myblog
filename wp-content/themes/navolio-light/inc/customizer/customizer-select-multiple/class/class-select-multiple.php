 ...
 * @access public
 */
class Navolio_Light_Select_Multiple extends WP_Customize_Control {
	/**
	...
	/**
	 * Autotax_Select_Multiple constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_script( 'aurprax-customizer-select-multiple', get_theme_file_uri( '/inc/customizer/customizer-select-multiple/js/script-select-multiple.js' ), array( 'jquery', 'customize-base' ), '1.0', true );
	}
	/**
