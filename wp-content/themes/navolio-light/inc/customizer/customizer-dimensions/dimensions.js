wp.customize.controlConstructor['navolio-light-dimensions'] = wp.customize.Control.extend({
...
jQuery( document ).ready( function($) {
	...
	// Linked button
	$( '.navolio-light-linked' ).on( 'click', function() {
	...
	// Unlinked button
	$( '.navolio-light-unlinked' ).on( 'click', function() {
