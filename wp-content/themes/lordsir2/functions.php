...
function theme_setup() {
	...
	load_theme_textdomain( 'lordsir', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Navigation', 'lordsir' ),
	) );
	...
	add_custom_image_header( '', 'lordsir_admin_header_style' );
...
if ( ! function_exists( 'lordsir_admin_header_style' ) ) :
function lordsir_admin_header_style() {
?>
<style type="text/css">
#headimg {
...
function lordsir_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'lordsir_page_menu_args' );


function lordsir_excerpt_length( $length ) {
	return 40;
}
add_filter( 'excerpt_length', 'lordsir_excerpt_length' );


function lordsir_continue_reading_link() {
	return ' <a href="'. get_permalink() . '">' . __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'lordsir' ) . '</a>';
}

function lordsir_auto_excerpt_more( $more ) {
	return ' &hellip;' . lordsir_continue_reading_link();
}
add_filter( 'excerpt_more', 'lordsir_auto_excerpt_more' );


function lordsir_custom_excerpt_more( $output ) {
	if ( has_excerpt() && ! is_attachment() ) {
		$output .= lordsir_continue_reading_link();
	}
	return $output;
}
add_filter( 'get_the_excerpt', 'lordsir_custom_excerpt_more' );


add_filter( 'use_default_gallery_style', '__return_false' );


function lordsir_remove_gallery_css( $css ) {
	return preg_replace( "#<style type='text/css'>(.*?)</style>#s", '', $css );
}
if ( version_compare( $GLOBALS['wp_version'], '3.1', '<' ) )
	add_filter( 'gallery_style', 'lordsir_remove_gallery_css' );

if ( ! function_exists( 'lordsir_comment' ) ) :

function lordsir_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-author vcard">
			...
			<?php printf( __( '%s <span class="says">says:</span>', 'lordsir' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
		</div><!-- .comment-author .vcard -->
		<?php if ( $comment->comment_approved == '0' ) : ?>
			<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'lordsir' ); ?></em>
			<br />
		<?php endif; ?>
		...
		<div class="comment-meta commentmetadata"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
			<?php
				...
				printf( __( '%1$s at %2$s', 'lordsir' ), get_comment_date(),  get_comment_time() ); ?></a><?php edit_comment_link( __( '(Edit)', 'lordsir' ), ' ' );
			?>
	...
	<li class="post pingback">
		<p><?php _e( 'Pingback:', 'lordsir' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __( '(Edit)', 'lordsir' ), ' ' ); ?></p>
	<?php
			break;
	endswitch;
}
...
function lordsir_widgets_init() {

	register_sidebar( array(
		'name' => __( 'Primary Widget Area', 'lordsir' ),
		'id' => 'primary-widget-area',
		'description' => __( 'The primary widget area', 'lordsir' ),
	...
	register_sidebar( array(
		'name' => __( 'Secondary Widget Area', 'lordsir' ),
		'id' => 'secondary-widget-area',
		'description' => __( 'The secondary widget area', 'lordsir' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'First Footer Widget Area', 'lordsir' ),
		'id' => 'first-footer-widget-area',
		'description' => __( 'The first footer widget area', 'lordsir' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Second Footer Widget Area', 'lordsir' ),
		'id' => 'second-footer-widget-area',
		'description' => __( 'The second footer widget area', 'lordsir' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Third Footer Widget Area', 'lordsir' ),
		'id' => 'third-footer-widget-area',
		'description' => __( 'The third footer widget area', 'lordsir' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	register_sidebar( array(
		'name' => __( 'Fourth Footer Widget Area', 'lordsir' ),
		'id' => 'fourth-footer-widget-area',
		'description' => __( 'The fourth footer widget area', 'lordsir' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
...
add_action( 'widgets_init', 'lordsir_widgets_init' );

function lordsir_remove_recent_comments_style() {
	add_filter( 'show_recent_comments_widget_style', '__return_false' );
}
add_action( 'widgets_init', 'lordsir_remove_recent_comments_style' );

if ( ! function_exists( 'lordsir_posted_on' ) ) :

function lordsir_posted_on() {
	printf( __( '<span class="%1$s">Posted on</span> %2$s <span class="meta-sep">by</span> %3$s', 'lordsir' ),
		...
		sprintf( '<span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s">%3$s</a></span>',
			...
			esc_attr( sprintf( __( 'View all posts by %s', 'lordsir' ), get_the_author() ) ),
			get_the_author()
		)
	);
}
...
if ( ! function_exists( 'lordsir_posted_in' ) ) :

function lordsir_posted_in() {
	$tag_list = get_the_tag_list( '', ', ' );
	if ( $tag_list ) {
		$posted_in = __( 'This entry was posted in %1$s and tagged %2$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'lordsir' );
	} elseif ( is_object_in_taxonomy( get_post_type(), 'category' ) ) {
		$posted_in = __( 'This entry was posted in %1$s. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'lordsir' );
	} else {
		$posted_in = __( 'Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'lordsir' );
	}
	printf(
		$posted_in,
