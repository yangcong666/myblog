...
function my_videos( $atts, $content = null ) {
	...
	return '<div class="video-content"><a class="videos" href="'.$href.'" title="播放视频">'.$img.'<i class="play"></i></a></div>';
}
...
function my_avatar( $email = '1@yigujin.cn', $size = '40', $default = '', $alt = '') {
  ...
  if ( !is_file($e) || (time() - filemtime($e)) > $t ) {
    if ( !is_file($d) || (time() - filemtime($d)) > $t ) {
      // 验证是否有头像
      $uri = 'http://cn.gravatar.com/avatar/' . $f . '?d=404';
...
function hui_head_css() { 
	...
	if (get_option('ygj_paibanbj') == '图右') {
		$styles .= ".archive-list .thumbnail {float: right;margin: 0 0 0 20px;}#post_list_box .entry-meta {left:15px;}.readMore {display:none;}";
	}
	if ((get_option('ygj_cblbj') == '无侧边栏' && get_option('ygj_paibanbj') == '图下') || (get_option('ygj_cblbj') == '无侧边栏' && get_option('ygj_paibanbj') == '图上')) {
		$styles .= ".archive-list{width: 49%;float:left;}.shuangshu{margin-right:2%;}.archive-list .thumbnail {height:100%;}.archive-content {height: 105px;}";
	}
	if (get_option('ygj_paibanbj') == '图上' || get_option('ygj_paibanbj') == '图下') {
		$styles .= ".archive-list .thumbnail {float:none;margin: 0;width: 100%;}#post_list_box .entry-meta {left:15px;}@media screen and (max-width:768px){.archive-list{width: 100%;float:none;}.shuangshu{margin-right:0%;}.archive-list .entry-header h2 {height:auto;}.archive-list .entry-content {margin-top: 15px;}}@media screen and (max-width:568px){.archive-list .archive-content{line-height: 20px;}}";
	}
	if (get_option('ygj_cblbj') == '居左') {
		$styles .= "#primary{float: right;}#sidebar{float: left;}";
	}
	if (get_option('ygj_cblbj') == '无侧边栏') {
		$styles .= "#primary{width: 100%;}";
	}
	$skin_option = get_option('ygj_theme_skin'); 
	$skc = "#" . $skin_option; 
	
	if ($skin_option && ($skin_option !== "C01E22")) { 
		$styles .= "a:hover,.top-menu a:hover,.default-menu li a,#user-profile a:hover,#site-nav ul li.current-menu-parent>a,#site-nav .down-menu>.current-menu-item>a,#site-nav .down-menu>.current-menu-item>a:hover,#site-nav .down-menu>li.sfHover>a,#site-nav .down-menu>li>a:hover,.scrolltext-title a,#post_list_box .archive-list:hover h2 a,.entry-meta a,.single-content a,.single-content a:hover,.single-content a:visited,.showmore span,#post_list_box .comment a:hover,#post_list_box .post_cat a:hover,.single_banquan a,.single_info_w a,.single_banquan a:hover,.single_info a:hover,.single_info_w a:hover,.showmore span,.new_cat li.hov .title,#related-medias .media-list .media-inner .media-name,a.top_post_item:hover p,#teamnewslist li:hover b,#dzq .readers-list a:hover em,#dzq .readers-list a:hover strong{color:$skc}.sf-arrows ul .sfHover>.sf-with-ul:after,.sf-arrows ul li:hover>.sf-with-ul:after,.sf-arrows ul li>.sf-with-ul:focus:after{border-left-color:$skc}.sf-arrows>.sfHover>.sf-with-ul:after,.sf-arrows>li:hover>.sf-with-ul:after,.sf-arrows>li>.sf-with-ul:focus:after{border-top-color:$skc}#searchform button,.rslides_tabs .rslides_here a,.page-links span,.page-links a:hover span,#sidebar .widget_nav_menu a:hover,.widget_categories a:hover,.widget_links a:hover,#respond #submit,.comment-tool a:hover,#down a,.buttons a,.fancybox-close,.foot .p2 li .isquare,.new_cat li.hov .time,.post-password-form input[type=submit]:hover,.read-pl a:hover,.children a.at{background:$skc;}.post-date-ribbon,.readMore a,#sidebar .widget_nav_menu li:hover,.widget_categories li:hover,.widget_links li:hover{background-color:$skc}.corner{border-color:transparent transparent $skc transparent}.rslides_tabs .rslides_here a,.page-links span,.page-links a:hover span,#respond #submit,.comment-tool a:hover,#down a,.buttons a,.post-password-form input[type=submit]:hover{border:1px solid $skc;}.widget-title .cat,#top_post_filter .top_post_filter_active,#top_post_filter li:hover{border-bottom:3px solid $skc;}.comment-list li.comment_top3{border-bottom:1px dashed $skc;}.new_cat li.hov{border-bottom:1px dotted $skc}#teamnewslist li:hover b:after,#dzq .readers-list a:hover{border-color:$skc}@media screen and (min-width:550px){.pagination a:hover,.pagination span.current{border:1px solid $skc;background:$skc;}}@media screen and (max-width:550px){.pagination .next,.pagination .prev{background:$skc;}}.year{border-left:5px solid $skc!important;}button,#tag_letter li{background:$skc!important;}#all_tags li a:hover{color:$skc!important;}button{border:1px solid $skc!important;}"; 
	}  
	if ($styles) { 
...
if (get_option('ygj_gdjz') !== '标准页码') {
	function ajax_scroll_js() {if ( !is_singular() && !is_paged() ) {?>
