...
<?php wp_head(); ?>
<style type="text/css">
.page-template-template-code #primary{width:100%}textarea{background:#fff;border:1px solid #ccc}button{width:80px;background:#C01E22;color:#fff;margin:0 10px 10px 0;padding:6px;cursor:pointer;border:1px solid #C01E22;border-radius:2px;-webkit-appearance:none;transition:all .2s ease-in 0s}button:hover{opacity:.6}.options{margin:0 0 0 20px}.options_no{display:none}#preview{margin:0 0 50px 0;color:#fff;width:100%;height:100%}.dp-highlighter{border:1px solid #B9B9B9}.dp-highlighter{font:14px "Microsoft YaHei",微软雅黑,Helvetica,Arial,Lucida Grande,Tahoma,sans-serif;background:#fff;border:1px solid #e8e8e8;width:99%;word-break:break-all;white-space:normal;overflow:auto;margin:0 auto}.dp-highlighter .bar{padding:2px}.dp-highlighter .collapsed .bar,.dp-highlighter .nogutter .bar{padding-left:0}.dp-highlighter ol{margin:0 0 1px 32px;padding:2px;color:#666}.dp-highlighter.nogutter ol{list-style-type:none;margin-left:0}.dp-highlighter .columns div,.dp-highlighter ol li{border-left:2px solid #0196e3;padding-left:10px;line-height:18px}.dp-highlighter .nogutter .columns div,.dp-highlighter .nogutter ol li{border:0}.dp-highlighter .columns{color:gray;width:100%}.dp-highlighter .columns div{padding-bottom:5px}.dp-highlighter ol li span{color:#000}.dp-highlighter .collapsed ol{margin:0}.dp-highlighter .collapsed ol li{display:none}.dp-highlighter .printing{border:none}.dp-highlighter .printing .tools{display:none!important}.dp-highlighter .printing li{display:list-item!important}.dp-highlighter .tools{padding:3px 8px 3px 15px;border-bottom:1px solid #2B91AF;font:14px "Microsoft YaHei",微软雅黑,Helvetica,Arial,Lucida Grande,Tahoma,sans-serif;color:silver}.dp-highlighter .collapsed .tools{border-bottom:0}.dp-highlighter .tools a{font-size:9pt;color:gray;text-decoration:none;margin-right:10px}.dp-highlighter .tools a:hover{color:red;text-decoration:underline}.dp-about{background-color:# fff;margin:0;padding:0}.dp-about table{width:100%;height:100%;font:14px "Microsoft YaHei",微软雅黑,Helvetica,Arial,Lucida Grande,Tahoma,sans-serif}.dp-about td{padding:10px;vertical-align:top}.dp-about .copy{border-bottom:1px solid #ACA899;height:95%}.dp-about .title{color:red;font-weight:700}.dp-about .para{margin:0 0 4px 0}.dp-about .footer{background-color:#ECEADB;border-top:1px solid #fff;text-align:right}.dp-about .close{font:14px "Microsoft YaHei",微软雅黑,Helvetica,Arial,Lucida Grande,Tahoma,sans-serif;background-color:#ECEADB;width:60px;height:22px}.dp-c .comment{color:green}.dp-c .string{color:#00f}.dp-c .preprocessor{color:gray}.dp-c .keyword{color:#00f}.dp-c .vars{color:#d00}.dp-vb .comment{color:green}.dp-vb .string{color:#00f}.dp-vb .preprocessor{color:gray}.dp-vb .keyword{color:#00f}.dp-sql .comment{color:green}.dp-sql .string{color:red}.dp-sql .keyword{color:#7f0055}.dp-sql .func{color:#ff1493}.dp-sql .op{color:#00f}.dp-xml .cdata{color:#ff1493}.dp-xml .comments{color:green}.dp-xml .tag{font-weight:700;color:#00f}.dp-xml .tag-name{color:#7f0055;font-weight:700}.dp-xml .attribute{color:red}.dp-xml .attribute-value{color:#00f}.dp-delphi .comment{color:#008200;font-style:italic}.dp-delphi .string{color:#00f}.dp-delphi .number{color:#00f}.dp-delphi .directive{color:#008284}.dp-delphi .keyword{font-weight:700;color:navy}.dp-delphi .vars{color:#000}.dp-py .comment{color:green}.dp-py .string{color:red}.dp-py .docstring{color:green}.dp-py .keyword{color:#00f;font-weight:700}.dp-py .builtins{color:#ff1493}.dp-py .magicmethods{color:grey}.dp-py .exceptions{color:brown}.dp-py .types{color:brown;font-style:italic}.dp-py .commonlibs{color:#8A2BE2;font-style:italic}.dp-rb .comment{color:#c00}.dp-rb .string{color:#f0c}.dp-rb .symbol{color:#02b902}.dp-rb .keyword{color:#069}.dp-rb .variable{color:#6cf}.dp-css .comment{color:green}.dp-css .string{color:red}.dp-css .keyword{color:#00f}.dp-css .colors{color:#8b0000}.dp-css .vars{color:#d00}.dp-j .comment{color:#3f7f5f}.dp-j .string{color:#2a00ff}.dp-j .keyword{color:#7f0055;font-weight:700}.dp-j .annotation{color:#646464}.dp-j .number{color:#C00000}.dp-cpp .comment{color:#e00}.dp-cpp .string{color:red}.dp-cpp .preprocessor{color:#CD00CD;font-weight:700}.dp-cpp .keyword{color:#5697D9;font-weight:700}.dp-cpp .datatypes{color:#2E8B57;font-weight:700}.dp-perl .comment{color:green}.dp-perl .string{color:red}.dp-perl .keyword{color:#7f0055}.dp-perl .func{color:#ff1493}.dp-perl .declarations{color:#00f}.dp-css .vars{color:#d00}.dp-g .comment{color:#3f7f5f}.dp-g .string{color:#2a00ff}.dp-g .keyword{color:#7f0055;font-weight:700}.dp-g .type{color:#007f00;font-weight:700}.dp-g .modifier{color:#640064;font-weight:700}.dp-g .constant{color:red;font-weight:700}.dp-g .method{color:#ff6000;font-weight:700}.dp-g .number{color:#C00000}
</style>
	...
	<div id="menu-box">
		<div id="top-menu">
			...
			<div id="site-nav-wrap">
				<div id="sidr-close"><a href="<?php echo esc_url( home_url() ); ?>/#sidr-close" class="toggle-sidr-close">关闭</a>
			</div>
	...
	<?php the_content(); ?>
     <h2>在线代码高亮转换工具：适用于发表文章或者留言时粘代码之用，Design by <a title="Robin" href="http://zmingcx.com" target="_blank" rel="nofollow"> Robin</a>。</h2><br/>
				...
				<span class="options">选项：&nbsp;
					...
					<input id=showGutter type=checkbox> 显示行号
				...
				<h2>HTML 代码（Ctrl+A进行全选，复制粘贴代码请用鼠标右键或者快捷键！）</h2>
				<textarea id=htmlCode style="width: 100%" name=htmlCode rows=10></textarea>
				<h2>HTML 预览</h2>
				<div id="preview"></div>	
	</div>
			</div>
