...
<?php get_header(); ?>
<style type="text/css">
.year{font-size:18px;font-size:1.8rem;line-height:150%;margin:10px 0;padding:0 0 0 5px;border-left:5px solid #C01E22}.mon{color:#000;line-height:30px;margin:5px 0 5px 5px;cursor:pointer}.post_list li{line-height:30px;text-indent:2em}.post_list{color:#999;margin:0 0 10px 0}
</style>
