<?php if ( is_home() ) { ?><title><?php bloginfo('name'); ?><?php echo stripslashes(get_option('ygj_lianjiefu')); ?><?php bloginfo('description'); ?></title><?php } ?>
...
<?php endif; }?>
<?php if ( is_tag() ) { 
$tag = get_the_tags(); $term_id = $tag[0]->term_id; $tag_name = $tag[0]->name; 
