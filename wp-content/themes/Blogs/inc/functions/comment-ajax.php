...
?>
	...
	<div class="comment-author vcard">
		...
		<?php printf( __( '<cite class="fn">%s</cite> <span class="says">:</span>' , 'Nana'), get_comment_author_link() ); ?>
		
		<span class="comment-meta commentmetadata">
			<a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ); ?>">
			<?php printf( __('%1$s at %2$s', 'Nana'), get_comment_date( 'Y年m月d日' ),  get_comment_time() ); ?></a>
		</span>
	</div>
	<div class="plbj"><?php comment_text(); ?></div>
