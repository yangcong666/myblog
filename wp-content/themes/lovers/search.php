	  ...
	  <?php /* If this is an author archive */ } elseif (is_author()) { ?>
 	  ...
 	  <?php } ?>
          ...
          <div class="sub_desc"><?php the_author() ?> 发表于: <?php the_time('F jS, Y') ?> | 阅读: <?php if(function_exists('the_views')) { the_views(); } ?> | 评论数: <?php comments_popup_link('(0)', '(1)', '(%)'); ?> </div> 
                            ...
                            <div class="post_content"> <?php the_content('Read the rest of this entry &raquo;'); ?> </div> 
        
                            <div class="post_meta"><div class="post_cats">分类:<?php the_category(', ') ?></div><strong><a title="阅读全文" href="<?php the_permalink() ?>" rel="bookmark">阅读全文</a></a></div> 
               </div> 
	  ...
	  <?php /* If this is an author archive */ } elseif (is_author()) { ?>
 	  ...
 	  <?php } ?>
                        ...
                        <div class="sub_desc"><?php the_author() ?> 发表于: <?php the_time('F jS, Y') ?> | 阅读: <?php if(function_exists('the_views')) { the_views(); } ?> | 评论数: <?php comments_popup_link('(0)', '(1)', '(%)'); ?> </div> 
                            ...
                            <div class="post_content"><p><span><span id="content"><?php the_content('Read the rest of this entry &raquo;'); ?> </div> 
