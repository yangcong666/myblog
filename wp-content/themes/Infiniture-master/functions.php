<?php
/**
 * infiniture functions and definitions
 *
...
if ( ! function_exists( 'infiniture_setup' ) ) :
	/**
	 ...
	 */
	function infiniture_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on infiniture, use a find and replace
		 * to change 'infiniture' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'infiniture', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'infiniture_custom_background_args', array(
...
add_action( 'widgets_init', 'infiniture_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function infiniture_scripts() {
	wp_enqueue_style( 'infiniture-style', get_stylesheet_uri() );

	wp_enqueue_script( 'infiniture-custom', get_template_directory_uri() . '/js/script.js', array(), '20151215', true );

	wp_enqueue_script( 'infiniture-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'infiniture-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'infiniture_scripts' );
