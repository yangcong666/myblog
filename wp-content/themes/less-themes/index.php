...
?>
			<?php if ( have_posts() ) : ?>
						...
						<div class="post-meta">
							<?php if( comments_open() ) : ?>
								<span class="comments-link">
									<?php comments_popup_link( __( '评论', 'break' ), __( '1个评论', 'break' ), __( '% 个评论', 'break' ) ); ?>
								</span>
							<?php endif; ?>
				...
				<div id="pagination" class="clearfix">
					<div class="past-page"><?php previous_posts_link( '下一页 &raquo;' ); ?></div>
					<div class="next-page"><?php next_posts_link( ' &laquo; 上一页' ); ?></div>
				</div><!-- pagination -->
...
?>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<article class="post">
						...
						<div class="post-meta">
							<?php if( comments_open() ) : ?>
								<span class="comments-link">
									<?php comments_popup_link( __( '评论', 'less' ), __( '1 个评论', 'less' ), __( '% 个评论', 'less' ) ); ?>
								</span>
							<?php endif; ?>
				...
				<?php
					// If comments are open or we have at least one 评论, load up the 评论 template
