					...
					<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
						...
						<?php do_atomic( 'before_entry' ); // oxygen_before_entry ?>
							...
							<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
								...
								<div class="byline byline-cat"><?php the_category(', '); ?></div>
					...
					<?php if ( $loop->have_posts() ) : ?>
						...
						<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
							...
							<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
								...
								<div class="byline"><a href="<?php the_permalink(); ?>"><?php echo get_the_date(); ?></a> / by <?php the_author_posts_link(); ?> / in <?php the_category(', '); ?> <?php edit_post_link(); ?></div>
