...
function custom_login_logo(){
  ...
  echo '<script type="text/javascript" src="'.get_bloginfo("template_url").'/js/public/jquery-1.11.2.min.js"></script><script type="text/javascript">$(document).ready(function() {$("#login h1 a").attr("href", "http://www.soaky.cn").attr("target", "_blank");});</script>';
}
...
//shejiwo_comment
function shejiwo_comment($comment, $args, $depth) {
