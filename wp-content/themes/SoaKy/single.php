    ...
    <div id="Central">
      ...
      <div class="postSingle">
        ...
        <div class="postsingle rbox">
            ...
            <!-- 版权信息 -->
			<div class="postsingle_info minfo">
			<span><i class="fa fa-exclamation-triangle"></i> 本站原创文章，请勿复制转载</span>
			</div>
            <div class="postsingle_info sm_none">
			<span><i class="fa fa-exclamation-triangle"></i>	版权声明：除特别注明外，本站所有文章均为原创，未经许可请勿复制、转载</span>
            </div>
            <!-- 版权信息 -->

            <!-- 底部信息栏 -->
            <div class="postsingle_bottom clearfix">
              <div class="pl_small f_l"><span class="pl_cate"><i class="fa fa-clone"></i> <?php the_category(', ') ?></span></div>			
              <div class="pl_small f_l"><span class="pl_time"><i class="fa fa-calendar"> </i> <?php the_time('Y-m-d'); ?></span></div>			  
              <?php if(function_exists('the_views')) { ?>
              <div class="pl_small f_l"><span class="pl_views"><i class="fa fa-user-o"></i> <?php the_views(); ?></span></div>
              <?php }?>
              ...
              <div class="sm_none"><div class="pl_small f_l"><i class="fa fa-tags"></i> <?php the_tags('标签： ', ', ', ''); ?></div></div>
            </div>
            <!-- 底部信息栏 -->
