...
<div class="form-group respond_input">
  <label for="author"><?php _e('Name'); ?> <?php if ($req) _e(' <font color=red> *</font>'); ?></label>
...
<div class="form-group respond_input">
  <label for="email"><?php _e('邮件'); ?> <?php if ($req) _e(' <font color=red> *</font>'); ?></label>
...
<div class="form-group respond_textarea">
  ...
  <textarea class="form-control b-r0" name="comment" id="comment" cols="58" rows="3" tabindex="4"></textarea>
</div>
