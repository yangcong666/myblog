 ...
 <div id="content" class="site-content"> 
  ...
  <main id="main" class="site-main" role="main"> 
   ...
   <nav class="nav-single wow" data-wow-delay="0.3s" > 
   	<?php previous_post_link('%link', '<span class="meta-nav"><span class="post-nav"><i class="fa fa-angle-left"></i> 上一篇</span><br />%title</span>', TRUE); ?>
    <?php next_post_link('%link', '<span class="meta-nav"><span class="post-nav">下一篇 <i class="fa fa-angle-right"></i></span><br />%title</span>', TRUE); ?>
    <div class="clear"></div> 
   </nav> 
   <!-- 引用 -->
