...
<body <?php body_class(); ?>>
	...
	<div class="header-top">
		<div class="header-logo" border-radius:50% >
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img id="myheader-logo" height="60" width="60" src="http://114.116.235.65/wp-content/uploads/2019/11/yconion-1.jpg"></a>
		</div>
